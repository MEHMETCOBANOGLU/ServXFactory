...
// send text message to firestore
  ...
  Future<void> sendFileMessage({
    ...
    try {
      ...
      final ref =
          '${'chatFiles'}/${messageType.name}/${sender.id}/$contactUID/$messageId';
  ...
  Future<void> deleteMessage({
    ...
    if (isGroupChat) {
      ...
      if (deleteForEveryone) {
        ...
        final groupData =
            await _firestore.collection('groups').doc(contactUID).get();
  ...
  Future<void> deleteFileFromStorage({
    ...
    await firebaseStorage
        .ref(
            '${'chatFiles'}/$messageType/$currentUserId/$contactUID/$messageId')
        .delete();
  }
