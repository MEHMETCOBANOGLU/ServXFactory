...
import 'package:ServXFactory/pages/chatPages/main_screen/widgets/friend_widget.dart';
import 'package:ServXFactory/pages/chatPages/main_screen/widgets/settings_list_tile.dart';
import 'package:ServXFactory/pages/chatPages/main_screen/widgets/settings_switch_list_tile.dart';
  ...
  String getGroupAdminsNames({
    ...
    if (groupProvider.groupMembersList.isEmpty) {
      ...
      List<String> groupAdminsNamesList = groupAdminsList.map((groupAdmin) {
        return groupAdmin.id == uid ? 'You' : groupAdmin.name;
      }).toList();
