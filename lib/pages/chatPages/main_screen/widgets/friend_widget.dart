...
class FriendWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final uid = context.watch<AuthenticationProvider>().userModel!.id;
    final name = uid == friend.id ? 'You' : friend.name;
    bool getValue() {
      return isAdminView
    ...
    return ListTile(
              ...
              onPressed: () async {
                if (groupId.isEmpty) {
                  ...
                  await context
                      ...
                      .acceptFriendRequest(friendID: friend.id)
                      .whenComplete(() {
                    showSnackBar(
      ...
      onTap: () {
        if (viewType == FriendViewType.friends) {
          ...
          //   Constants.contactUID: friend.id,
          ...
          Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) => ChatScreen(
                        contactUID: friend.id,
                        contactName: friend.name,
                        contactImage: friend.image,
                        groupId: '',
                      )));
