...
import 'package:ServXFactory/pages/chatPages/main_screen/widgets/message_widget.dart';
import 'package:emoji_picker_flutter/emoji_picker_flutter.dart';
import 'package:ServXFactory/pages/chatPages/main_screen/models/message_model.dart';
import 'package:ServXFactory/pages/chatPages/main_screen/models/message_reply_model.dart';
...
import 'package:ServXFactory/pages/chatPages/main_screen/widgets/align_message_left_widget.dart';
import 'package:ServXFactory/pages/chatPages/main_screen/widgets/align_message_right_widget.dart';
...
class _ChatListState extends State<ChatList> {
  ...
  void onContextMenyClicked(
    ...
    switch (item) {
      ...
      case 'Delete':
        final currentUserId =
            context.read<AuthenticationProvider>().userModel!.id;
  ...
  void sendReactionToMessage(
    ...
    // get the sender uid
    final senderUID = context.read<AuthenticationProvider>().userModel!.id;
                        ...
                        gradient: LinearGradient(
                          ...
                          colors: [
                            AppTheme.lightTheme.dialogBackgroundColor
                                .withOpacity(0.3), // Üst kısım şeffaf
                            AppTheme.lightTheme
                                .dialogBackgroundColor, // Ortaya doğru opak
                            AppTheme.lightTheme.dialogBackgroundColor
                                .withOpacity(0.3), // Alt kısım şeffaf
                          ],
                          stops: [0.0, 0.5, 1.0], // Geçiş noktaları
                        )),
                    child: Text(
                      formattedDate,
