import 'package:ServXFactory/pages/chatPages/main_screen/group_information_screen.dart';
...
import 'package:ServXFactory/pages/chatPages/main_screen/widgets/group_members.dart';
          ...
          onTap: () {
            ...
            context
              ...
              Navigator.push(context, MaterialPageRoute(builder: (context) {
                return const GroupInformationScreen();
              }));
              // Navigator.pushNamed(context, GroupInformationScreen());
            });
          },
          child: Row(
            children: [
