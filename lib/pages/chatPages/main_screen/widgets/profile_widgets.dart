...
import 'package:ServXFactory/pages/chatPages/main_screen/friend_requests_screen.dart';
import 'package:ServXFactory/pages/chatPages/main_screen/friends_screen.dart';
...
class FriendsButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Widget buildFriendsButton() {
      if (currentUser.id == userModel.id && userModel.friendsUIDs.isNotEmpty) {
        ...
        if (currentUser.id != userModel.id) {
          ...
          if (userModel.friendRequestsUIDs.contains(currentUser.id)) {
            // show send friend request button
            return MyElevatedButton(
              onPressed: () async {
                await context
                    .read<AuthenticationProvider>()
                    .cancleFriendRequest(friendID: userModel.id)
                    .whenComplete(() {
            ...
            return MyElevatedButton(
              onPressed: () async {
                await context
                    .read<AuthenticationProvider>()
                    .acceptFriendRequest(friendID: userModel.id)
                    .whenComplete(() {
                  showSnackBar(
          ...
          } else if (userModel.friendsUIDs.contains(currentUser.id)) {
            return Row(
              ...
              children: [
                        ...
                        actions: [
                          ...
                          TextButton(
                            onPressed: () async {
                              ...
                              await context
                                  .read<AuthenticationProvider>()
                                  .removeFriend(friendID: userModel.id)
                                  .whenComplete(() {
                                showSnackBar(
                ...
                MyElevatedButton(
                  onPressed: () async {
                    ...
                    //     arguments: {
                    //       Constants.contactUID: userModel.id,
            ...
            return MyElevatedButton(
              onPressed: () async {
                await context
                    .read<AuthenticationProvider>()
                    .sendFriendRequest(friendID: userModel.id)
                    .whenComplete(() {
